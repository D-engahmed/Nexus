...
class _LoginScreenState extends State<LoginScreen> {
  final _emailController = TextEditingController(text: 'customer@nexus.com');
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Nexus Delivery', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                  const SizedBox(height: 8),
                  const Text('Sign in to continue', style: TextStyle(fontSize: 16, color: AppColors.textSecondary)),
                  ...
                  const SizedBox(height: 16),
                  Text('Demo: customer@nexus.com / 123456', style: TextStyle(color: AppColors.textHint, fontSize: 12)),
                ],
              ),
            ),
          ),
